                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="hapusdata.php?id_siswa=<?= $res['id_kelas'] ?>"
                                                ...
                                                data-bs-target="#myModal" id="<?php echo $res['id_kelas']; ?>">Edit</a>
                                            </td> 
                                        </tr>
                                        <?php endwhile; ?>
                                    </tbody>
...
if(isset($_POST['simpan'])) {
    ...
    if($exec) {
        ...
        echo "<script>alert('Data kelas gagal disimpan. Kesalahan: ". mysqli_error($conn)."')
        document.location = 'editdatasiswa.php';
        </script>";
    }
...
if(isset($_POST['edit'])) {
    ...
    if($exec) {
        ...
        echo "<script>alert('dDta kelas gagal diedit')
        document.location = 'editdatakelas.php' </script>;
        "
        ;
